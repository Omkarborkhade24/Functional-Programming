const books = [
  ...
  { id: 2, title: 'Book 2', price: 0.0, isFree: true },
  { id: 3, title: 'Book 3', price: 9.99, isFree: false },
  { id: 4, title: 'Book 4', price: 0.0, isFree: true },
];
...
function renderBooks(filteredOnlyFree) {
  const filteredBooks = filteredOnlyFree
